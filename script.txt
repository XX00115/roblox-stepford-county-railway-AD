...
local settings = { -- suggest only change the kds and tms
    ...
    tms = 3000, -- change train max speed
    kds = 1000, -- auto drive speed (dont higher then max speed)
}
